        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-8">
                    ...
                    <img src="{{ url('image/' . $id->foto) }}" alt="Foto Produk" class="img-thumbnail" style="max-width: 150px;">
                    @else
                    <img src="{{ url('image/nophoto.jpg') }}" alt="No Foto" class="img-thumbnail" style="max-width: 150px;">
                    @endif
                </div>
            </div>
        </div>
