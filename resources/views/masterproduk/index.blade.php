...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        <div class="card-header">
            {{-- <i class=""></i> --}}
            <a href="{{ route('admin.masterproduk.index') }}" class="btn btn-sm btn-primary">Tambah data</a>
        </div>
        <div class="card-body">
            <table id="datatablesSimple">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.masterproduk.show', $k->id) }}" class="btn btn-sm btn-secondary">show</a>
                            <a href="{{ route('admin.masterproduk.edit',  $k->id) }}" class="btn btn-sm btn-warning">edit</a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="{{ route('admin.masterproduk.destroy', $k->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
