    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            <div class="card-header">
                {{-- <i class=""></i> --}}
                <a href="{{ route('admin.masterproduk.create') }}" class="btn btn-sm btn-primary">Tambah data</a>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($masterproduk as $k)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.masterproduk.show', $k->id) }}"
                                        class="btn btn-sm btn-secondary">show</a>
                                    <a href="{{ route('admin.masterproduk.edit', $k->id) }}"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{ route('admin.masterproduk.destroy', $k->id) }}"
